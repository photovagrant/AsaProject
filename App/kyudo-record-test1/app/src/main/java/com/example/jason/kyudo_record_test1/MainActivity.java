...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        results.add(new result("null3"));
        results.add(new result("null4"));
        results.add(new result("null5"));
        results.add(new result("null6"));
        results.add(new result("null7"));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent actchange= new Intent ( MainActivity.this,SubActivity.class );
                result www=new result ( "1234" );
                actchange.putExtra ( "tag",www );

                startActivityForResult ( actchange ,0);
...
//                    mvideoView.requestFocus();
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new SmallViewHolder(LayoutInflater.from(ctx).inflate(R.layout.image2,parent,false));
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
           ...
           // Glide.with(ctx).load("http://vignette4.wikia.nocookie.net/robber-penguin-agency/images/6/6e/Small-mario.png/revision/latest?cb=20150107080404").into(((SmallViewHolder)holder).imageView);
